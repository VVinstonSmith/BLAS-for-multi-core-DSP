#ifndef irr_thinB_dgemm_KERNEL_H
#define irr_thinB_dgemm_KERNEL_H
...
__global__ void  irr_thinB_dgemm_null(unlong M, unlong N, unlong K, unlong b_id, double* A, double* B, double* C);
// do nothing
